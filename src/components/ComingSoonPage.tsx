...
export const ComingSoonPage: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            {/* Landing Text - Only visible when video is NOT playing */}
            {!showVideo && (
                ...
                >
                    ...
                    <div className="absolute bottom-24 md:bottom-10 left-1/2 -translate-x-1/2 flex gap-6 md:gap-8 items-center opacity-0 group-hover/video:opacity-100 transition-opacity duration-500 z-50">
                        <button
                            ...
                            className="whitespace-nowrap text-white/50 hover:text-white text-[8px] md:text-[10px] tracking-[0.4em] uppercase transition-all duration-300"
                        >
                            close
                        </button>
                        <button
            ...
            {/* ₥AN$A Logo - Always visible, highest layer */}
